...
export function CustomRequestSection({ locale, dict }: Props) {
  ...
  return (
    <>
      ...
      <CustomRequestModal open={open} onClose={() => setOpen(false)} locale={locale} dict={dict} />
    </>
  );
}
...
function CustomRequestModal({ open, onClose, locale, dict }: ModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="p-6 sm:p-8">
          ...
          <CustomRequestForm locale={locale} dict={dict} onSuccess={onClose} />
        </div>
      </div>
    </div>,
    document.body,
